...
<body>
    ...
    <section class="log-in-section section-b-space">
        <a href="" class="logo-login"><img src="{{ asset('dashboard_asset/images/logo/1.png') }}" alt="img1"
                class="img-fluid"></a>
                ...
                <div class="col-xl-5 col-lg-6 me-auto">
                    <div class="log-in-box">
                        <div class="log-in-title">
                            <h3 class="fw-bold">Welcome To Fastkart</h3>
    ...
    <!-- latest jquery-->
    <script src="dashboard_asset/js/jquery-3.6.0.min.js"></script>

    <!-- Bootstrap js-->
    <script src="dashboard_asset/js/bootstrap/bootstrap.bundle.min.js"></script>

    <!-- Theme js-->
    <script src="dashboard_asset/js/script.js"></script>
</body>
