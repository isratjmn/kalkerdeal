        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="custome-1-bg b-r-4 card-body">
                            <div class="media align-items-center static-top-widget">
                                <div class="media-body p-0">
                                    ...
                                    <h4 class="mb-0 counter">{{ $users->count() }}
                ...
                @php
                    ...
                    echo $user_collect->where('role', 'customer')->count();
                @endphp
                <div class="col-sm-6 col-xxl-3 col-lg-6">
                    <div class="main-tiles border-5 border-0  card-hover card o-hidden">
                        <div class="custome-1-bg b-r-4 card-body">
                ...
                <div class="col-sm-6 col-xxl-3 col-lg-6">
                    <div class="main-tiles border-5 border-0  card-hover card o-hidden">
                        <div class="custome-1-bg b-r-4 card-body">
                            <div class="media align-items-center static-top-widget">
                                <div class="media-body p-0">
                                    <span class="m-0">Total Vendor</span>
                                    <h4 class="mb-0 counter">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="best-product-box">
                                                        <div class="product-image">
                                                            <img src="{{ asset('dashboard_asset') }}/images/product/1.png"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="best-product-box">
                                                        <div class="product-image">
                                                            <img src="{{ asset('dashboard_asset') }}/images/product/2.png"
                                                                class="img-fluid" alt="Product">
                                                        </div>
                                                        <div class="product-name">
                                                            <h5>Aata Buscuit</h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="best-product-box">
                                                        <div class="product-image">
                                                            <img src="{{ asset('dashboard_asset') }}/images/product/3.png"
                                                                class="img-fluid" alt="Product">
                                                        </div>
                                                        <div class="product-name">
                                                            <h5>Aata Buscuit</h5>
